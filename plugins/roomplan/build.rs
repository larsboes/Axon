...
fn main() {
  ...
  // Swift target is `RoomPlanPlugin`, so promote our bridge symbol explicitly
  // after SwiftPM produces the archive.
  promote_ios_export("tauri-plugin-roomplan", "_init_plugin_roomplan");
}

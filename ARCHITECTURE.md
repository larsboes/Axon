...
> Generated: 2026-09-06T23:05:54Z | Source: axon.toml + upstreams.toml + systems.toml + capabilities/ + Packs/
...
| `harness` | Keep the agent harness itself in shape: propose the skills the recorded work actually needs, and shrink what loads into every session without dropping a rule. | suggest-skills, trim | — |

...
> Generated: 2026-08-19T03:24:06Z | Source: axon.toml + upstreams.toml + systems.toml + capabilities/ + Packs/
...
- **inspiration**: iai-personal-memory-engine, local-llm, paperless-ngx, awesome-selfhosted, colibri, exo, mlx, llama-cpp-rpc, mcpserver-audit, telekom-mcp-security, scout, trek-travel, tripit, betterbahn, besser-bahn, plan-bahn, nvidia-skills, slm-finetuning-talk
- **quarry**: oberskills, academic-writing-agents, research-paper-writing-skills, pengsida-research-notes, event-horizon
- **reject**: stop-slop, skills-best-practices, esphome, mosquitto, netbird, multilingual-e5-small-mlx

...
> Generated: 2026-09-13T19:36:01Z | Source: axon.toml + upstreams.toml + systems.toml + capabilities/ + Packs/
...
| `presentations` | Build, check, render and readiness-check slide decks as .pptx from a Python module, with talk-genre profiles (DSR/qualitative defence, empirical-CS talk), a role-based theme, and a contact-sheet verification loop. | slide-deck | — |

...
> Generated: 2026-08-02T18:07:04Z | Source: axon.toml + upstreams.toml + systems.toml + capabilities/ + Packs/
...
| `comms` | General observed-information intake for Axon, plus read-only mail triage. | — | `8083` | — |
...
| `knowledge-graph` | Interactive browser view and REST API for the Axon code-dependency graph built by [graphify](https://github.com/safishamsi/graphify). | — | `4244` | `4244/` |
...
| `axon` | Operate Axon and work on its repository through one progressively disclosed, dynamically grounded skill. | axon | — |
...
- **reject**: stop-slop, esphome, grafana, influxdb, mosquitto, netbird, multilingual-e5-small-mlx

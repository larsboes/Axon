...
> Generated: 2026-08-26T06:05:55Z | Source: axon.toml + upstreams.toml + systems.toml + capabilities/ + Packs/
...
- **adopt**: mcp-audit, hledger, semgrep, gitleaks, osv-scanner, trivy, vaultwarden, bitwarden-cli, postgres, r2d2, r2d2_postgres, bun, maplibre-gl-js, mermaid, vega, vega-lite, vega-embed, openfreemap, wikimedia-api, nominatim-api, graphify, bottom, macmon, typst, yq, vibecoded-design-tells, human-voice, home-assistant, pihole, stevenblack-hosts, tailscale, svelte-ai-tools, sveltejs-mcp, svelte-language-server, pi-coding-agent, apple-container, debian, deutsche-bahn-data, arrow-rs, xberg, ar5iv, multilingual-e5-base-mlx, bge-reranker-v2-m3-mlx, pascal-editor
...
- **reject**: rules_rust, platforms, rules_shell, stop-slop, skills-best-practices, esphome, mosquitto, netbird, multilingual-e5-small-mlx

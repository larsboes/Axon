...
`ai-cadence-tells.md` for the academic handling of related rhythm patterns at the multi-sentence
level; the tells themselves are defined in `human-writing`'s catalog).

...
_MODS = ["util", "defaults", "hit", "patterns", "textutil", "checks",
...
__all__ = []
for _name in _MODS:
    # _name can only come from the static module allowlist above, never caller input.
    _mod = importlib.import_module("." + _name, __name__)  # nosemgrep: python.lang.security.audit.non-literal-import.non-literal-import

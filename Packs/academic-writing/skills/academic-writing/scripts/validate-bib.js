...
/*
  ...
  Usage:
    node validate-bib.js path/to/references.bib

  Ported from a third-party academic-researcher skill's scripts/validate-bib.js (2026-07) — already
  generic and CLI-arg-driven, no changes needed beyond the file move.
*/
...
async function main() {
  ...
  if (!bibPath) {
    console.log('Usage: node validate-bib.js path/to/references.bib');
    process.exit(0);
  }

...
5. Query current GitHub issue or PR metadata when the task is issue-driven.
...
State the intended file and issue scope before editing. Do not absorb nearby cleanup merely

...
Most commonly used functions. The complete per-type reference (Date, String, Number, List, File, Link, Object, RegExp) is in *Appendix — Complete functions reference* below; read it rather than writing formulas from memory.
...
- Complete functions reference: *Appendix — Complete functions reference*, below
